...
-- ZENITHX: White and Black Theme
local THEME = {
	Background = Color3.fromRGB(10, 10, 10),      -- Almost black
	Section = Color3.fromRGB(20, 20, 20),         -- Dark gray
	Card = Color3.fromRGB(25, 25, 25),             -- Slightly lighter dark gray
	Accent = Color3.fromRGB(255, 255, 255),        -- Pure white
	AccentDark = Color3.fromRGB(200, 200, 200),    -- Light gray
	Text = Color3.fromRGB(255, 255, 255),          -- White
	DarkText = Color3.fromRGB(180, 180, 180),      -- Light gray
	Outline = Color3.fromRGB(60, 60, 60),          -- Medium gray
	SliderTrack = Color3.fromRGB(30, 30, 30),      -- Dark gray
	InputBg = Color3.fromRGB(35, 35, 35),          -- Dark gray
	ToggleOff = Color3.fromRGB(50, 50, 50),        -- Medium dark gray
	FloatButton = Color3.fromRGB(15, 15, 15),      -- Dark gray
	ProgressBg = Color3.fromRGB(20, 20, 20),       -- Dark gray
	ProgressFill = Color3.fromRGB(255, 255, 255),  -- White
}
...
local CONFIG_NAME, lastSaveTime, savedAnimate = "ZenithXConfig", 0, nil
local floatButtons = {}
...
local function createESP(plr)
	...
	hitbox.Color3 = Color3.fromRGB(255, 255, 255)  -- White
...
local function updateToggleUI(name, state)
	...
	btn.state = state
	btn.track.BackgroundColor3 = state and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(60, 60, 60)  -- White when on
	btn.dot.BackgroundColor3 = state and Color3.fromRGB(10, 10, 10) or Color3.fromRGB(255, 255, 255)  -- Black dot when on
...
local function setupChar(c)
	...
	if head then
		...
		speedLbl.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)  -- Black stroke
	end
	if galaxyEnabled then
...
ScreenGui.Name = "ZenithXGUI"  -- Changed from VoidHubGUI
local guiParent
pcall(function()
	if gethui then
		guiParent = gethui()
...
HUDTitle.Text = "ZENITH X"  -- Changed
HUDTitle.TextColor3 = THEME.Accent  -- White
...
FPSLabel.BackgroundTransparency = 1 FPSLabel.Text = "FPS: 0" FPSLabel.TextColor3 = THEME.Accent  -- White
...
PingLabel.BackgroundTransparency = 1 PingLabel.Text = "Ping: 0ms" PingLabel.TextColor3 = THEME.Accent  -- White
...
ProgressBarContainer.BackgroundColor3 = Color3.fromRGB(20, 20, 20)  -- Dark gray
...
pStroke.Thickness = 2
pStroke.Color = THEME.Accent  -- White
...
ProgressPercentLabel.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White
...
ProgressLabel.Text = ""
ProgressLabel.TextColor3 = THEME.Accent  -- White
...
RadiusLabelText.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White
...
RadiusInput.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White
...
pTrack.BackgroundColor3 = Color3.fromRGB(30, 30, 30)  -- Dark gray
pTrack.ZIndex = 2
...
ProgressBarFill.BackgroundColor3 = THEME.Accent  -- White
...
Main.BackgroundColor3 = THEME.Background  -- Black
Main.BorderSizePixel = 0 Main.Active = true
Instance.new("UICorner", Main).CornerRadius = UDim.new(0, s(18))

local MainStroke = Instance.new("UIStroke", Main) MainStroke.Color = THEME.Outline MainStroke.Thickness = 1  -- Gray outline

local Header = Instance.new("Frame", Main)
Header.Size = UDim2.new(1, 0, 0, s(70)) Header.BackgroundColor3 = THEME.Section  -- Dark gray
...
HeaderFix.BackgroundColor3 = THEME.Section  -- Dark gray
HeaderFix.BorderSizePixel = 0

local Title = Instance.new("TextLabel", Header)
Title.Size = UDim2.new(0, s(300), 0, s(28)) Title.Position = UDim2.new(0.5, -s(150), 0, s(15))
Title.Text = "ZENITH X"  -- Changed
Title.TextColor3 = THEME.Accent  -- White
...
SubTitle.Text = "" SubTitle.TextColor3 = THEME.Accent  -- White
...
CredsLabel.Text = "" CredsLabel.TextColor3 = THEME.DarkText  -- Light gray
...
Content.ScrollBarThickness = s(4) Content.ScrollBarImageColor3 = THEME.Accent  -- White
...
local function createSection(name, order)
	...
	lbl.BackgroundTransparency = 1 lbl.Text = name:upper() lbl.TextColor3 = THEME.DarkText  -- Light gray
...
local function createToggle(name, keyHintPC, keyHintController, defaultState, callback, order)
	...
	TF.Size = UDim2.new(1, 0, 0, s(48)) TF.BackgroundColor3 = THEME.Card  -- Dark gray
	TF.BorderSizePixel = 0 TF.LayoutOrder = order
	...
	if badgeText and badgeText ~= "?" and badgeText ~= "" then
		...
		KB.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- White
		...
		KL.TextColor3 = Color3.fromRGB(0, 0, 0)  -- Black
		KL.Font = Enum.Font.GothamBold KL.TextSize = s(12)
	end
	local Label = Instance.new("TextLabel", TF)
	Label.Size = UDim2.new(1, -s(130), 1, 0) Label.Position = UDim2.new(0, s(52), 0, 0)
	Label.BackgroundTransparency = 1 Label.Text = name Label.TextColor3 = THEME.Text  -- White
	...
	Track.BackgroundColor3 = defaultState and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(60, 60, 60)  -- White or dark gray
	...
	Dot.BackgroundColor3 = defaultState and Color3.fromRGB(10, 10, 10) or Color3.fromRGB(255, 255, 255)  -- Black or white
	...
	Btn.MouseButton1Click:Connect(function()
		...
		Track.BackgroundColor3 = ns and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(60, 60, 60)
		Dot.BackgroundColor3 = ns and Color3.fromRGB(10, 10, 10) or Color3.fromRGB(255, 255, 255)
...
local function createTextInput(name, defaultVal, minVal, maxVal, callback, order, decimals)
	...
	SF.Size = UDim2.new(1, 0, 0, s(52)) SF.BackgroundColor3 = THEME.Card  -- Dark gray
	SF.BorderSizePixel = 0 SF.LayoutOrder = order
	...
	ValueBox.BackgroundColor3 = THEME.InputBg  -- Dark gray
	ValueBox.Text = fmtV(defaultVal) ValueBox.TextColor3 = THEME.Accent  -- White
...
local function createCarrySpeedInput(order)
	...
	Label.TextColor3 = THEME.Text  -- White
	...
	CarrySpeedInput.BackgroundColor3 = THEME.InputBg  -- Dark gray
	CarrySpeedInput.Text = string.format("%.1f", CARRY_SPEED)
	CarrySpeedInput.TextColor3 = THEME.Accent  -- White
...
local function createKeybindSetter(actionName, defaultPC, defaultController, order)
	...
	KF.Size = UDim2.new(1, 0, 0, s(52)) KF.BackgroundColor3 = THEME.Card  -- Dark gray
	KF.BorderSizePixel = 0 KF.LayoutOrder = order
	...
	KeyBtn.BackgroundColor3 = THEME.InputBg  -- Dark gray
	KeyBtn.Text = defaultPC and defaultPC.Name or "None"
	KeyBtn.TextColor3 = THEME.Text  -- White
	KeyBtn.Font = Enum.Font.GothamBold KeyBtn.TextSize = s(11) KeyBtn.BorderSizePixel = 0
	...
	KeyBtn.MouseButton1Click:Connect(function()
		...
		KeyBtn.Text = "Press..." KeyBtn.BackgroundColor3 = THEME.Section  -- Dark gray
		KeyBtn.TextColor3 = THEME.Text  -- White
...
local function createCombatKeybindBadge(parent, actionName)
	...
	badge.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- White
	badge.BorderSizePixel = 0
	badge.Font = Enum.Font.GothamBold
	badge.TextSize = s(11)
	badge.TextColor3 = Color3.fromRGB(0, 0, 0)  -- Black
	...
	badge.MouseButton1Click:Connect(function()
		...
		badge.Text = "..." badge.BackgroundColor3 = THEME.Section  -- Dark gray
		badge.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White
		local conn
		conn = UserInputService.InputBegan:Connect(function(input)
			if listeningForKeybind ~= "CombatPC_"..actionName then conn:Disconnect() return end
			if input.UserInputType == Enum.UserInputType.Keyboard then
				KEYBINDS[actionName].PC = input.KeyCode
				badge.BackgroundColor3 = Color3.fromRGB(255, 255, 255) listeningForKeybind = nil  -- White
				saveConfig() syncKeybindDisplays(actionName) conn:Disconnect()
			end
		end)
...
SaveBtn.BackgroundColor3 = THEME.Accent  -- White
SaveBtn.BorderSizePixel = 0 SaveBtn.Text = "Save Config"
SaveBtn.TextColor3 = Color3.fromRGB(0, 0, 0)  -- Black
SaveBtn.Font = Enum.Font.GothamBold SaveBtn.TextSize = s(16)
...
ToggleBtn.BackgroundColor3 = THEME.FloatButton  -- Dark gray
ToggleBtn.Text = "Z"  -- Changed from "V" to "Z" for Zenith
ToggleBtn.TextColor3 = THEME.Accent  -- White
...
local TBStroke = Instance.new("UIStroke", ToggleBtn) TBStroke.Color = THEME.Outline  -- Gray
...
local function createFloatButton(name, topLabel, bottomLabel, order, callback)
	...
	Btn.BackgroundColor3 = THEME.FloatButton  -- Dark gray
	Btn.BorderSizePixel = 0 Btn.LayoutOrder = order Btn.Text = ""
	Instance.new("UICorner", Btn).CornerRadius = UDim.new(0, s(14))
	local BtnStroke = Instance.new("UIStroke", Btn) BtnStroke.Color = THEME.Outline  -- Gray
	...
	TopLbl.TextColor3 = THEME.Accent  -- White
	TopLbl.Font = Enum.Font.GothamBold TopLbl.TextSize = s(15)
	...
	BotLbl.TextColor3 = THEME.DarkText  -- Light gray
	BotLbl.Font = Enum.Font.GothamBold BotLbl.TextSize = s(13)
	local dotSz = s(7)
	local Indicator = Instance.new("Frame", Btn)
	Indicator.Size = UDim2.new(0, dotSz, 0, dotSz) Indicator.Position = UDim2.new(0.5, -dotSz/2, 1, -dotSz - s(6))
	Indicator.BackgroundColor3 = THEME.ToggleOff  -- Dark gray
...
createFloatButton("BatAimbot", "BAT", "AIMBOT", 1, function(state)
	setBatAimbot(state)
	floatButtons["BatAimbot"].state = batAimbotToggled
	floatButtons["BatAimbot"].indicator.BackgroundColor3 = batAimbotToggled and THEME.Accent or THEME.ToggleOff  -- White or dark gray
...
createFloatButton("AutoLeft", "AUTO", "LEFT", 2, function(state)
	setAutoLeft(state)
	floatButtons["AutoLeft"].state = autoLeftEnabled
	floatButtons["AutoLeft"].indicator.BackgroundColor3 = autoLeftEnabled and THEME.Accent or THEME.ToggleOff  -- White or dark gray
	if autoLeftEnabled then
		floatButtons["AutoRight"].state = false
		floatButtons["AutoRight"].indicator.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
		floatButtons["BatAimbot"].state = false
...
createFloatButton("AutoRight", "AUTO", "RIGHT", 3, function(state)
	setAutoRight(state)
	floatButtons["AutoRight"].state = autoRightEnabled
	floatButtons["AutoRight"].indicator.BackgroundColor3 = autoRightEnabled and THEME.Accent or THEME.ToggleOff  -- White or dark gray
	if autoRightEnabled then
		floatButtons["AutoLeft"].state = false
		floatButtons["AutoLeft"].indicator.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
		floatButtons["BatAimbot"].state = false
...
createFloatButton("SpeedToggle", "CARRY", "MODE", 4, function(state)
	speedToggled = state
	floatButtons["SpeedToggle"].state = speedToggled
	floatButtons["SpeedToggle"].indicator.BackgroundColor3 = speedToggled and THEME.Accent or THEME.ToggleOff  -- White or dark gray
